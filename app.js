...
const allreports = require('./reports.json');
...
app.get('/', async (req, res) => {
  const scope = 'report:eye-color report:beard-thickness report:morning-person report:folate report:response-to-vitamin-e-supplementation report:vitamin-a report:vitamin-b12 report:vitamin-d report:vitamin-e';
